...
namespace TestServer.Controllers
{
    ...
    public class VehicleConnectorTypeController : ControllerBase
    {
        ...
        {
            var vehicleConnectorTypes = await db
                .VehicleConnectorTypes.Include(vct => vct.Vehicle)
                .Include(vct => vct.Connector)
                .ToListAsync();

            var vehicleConnectorTypeDtos = vehicleConnectorTypes
                .Select(vct => new VehicleConnectorTypeDto
                {
