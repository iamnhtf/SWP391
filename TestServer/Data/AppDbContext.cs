...
public class AppDbContext : DbContext
{
    ...
    .HasConversion<string>();
        ...
        modelBuilder.Entity<ChargingPort>().HasData(
            ...
            new ChargingPort { Id = "1.1.2", PointId = "1.1", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "1.1.3", PointId = "1.1", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "1.2.1", PointId = "1.2", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "1.2.2", PointId = "1.2", ConnectorId = 2, Power = 150, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "1.2.3", PointId = "1.2", ConnectorId = 3, Power = 150, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "1.3.1", PointId = "1.3", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "1.3.2", PointId = "1.3", ConnectorId = 2, Power = 150, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "1.3.3", PointId = "1.3", ConnectorId = 3, Power = 150, Status = ChargingPortStatus.Available },
            ...
            new ChargingPort { Id = "1.4.3", PointId = "1.4", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "1.5.1", PointId = "1.5", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "1.5.2", PointId = "1.5", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "1.5.3", PointId = "1.5", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "1.6.1", PointId = "1.6", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "1.6.2", PointId = "1.6", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "1.6.3", PointId = "1.6", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "1.7.1", PointId = "1.7", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "1.7.2", PointId = "1.7", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "1.7.3", PointId = "1.7", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            // Station 2 (points 1..10)
            new ChargingPort { Id = "2.1.1", PointId = "2.1", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "2.1.2", PointId = "2.1", ConnectorId = 2, Power = 150, Status = ChargingPortStatus.Available },
            ...
            new ChargingPort { Id = "2.2.2", PointId = "2.2", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "2.2.3", PointId = "2.2", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "2.3.1", PointId = "2.3", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "2.3.2", PointId = "2.3", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "2.3.3", PointId = "2.3", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "2.4.1", PointId = "2.4", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "2.4.2", PointId = "2.4", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "2.4.3", PointId = "2.4", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "2.5.1", PointId = "2.5", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "2.5.2", PointId = "2.5", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "2.5.3", PointId = "2.5", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "2.6.1", PointId = "2.6", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "2.6.2", PointId = "2.6", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "2.6.3", PointId = "2.6", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "2.7.1", PointId = "2.7", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "2.7.2", PointId = "2.7", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "2.7.3", PointId = "2.7", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "2.8.1", PointId = "2.8", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "2.8.2", PointId = "2.8", ConnectorId = 2, Power = 150, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "2.8.3", PointId = "2.8", ConnectorId = 3, Power = 150, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "2.9.1", PointId = "2.9", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "2.9.2", PointId = "2.9", ConnectorId = 2, Power = 150, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "2.9.3", PointId = "2.9", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "2.10.1", PointId = "2.10", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "2.10.2", PointId = "2.10", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "2.10.3", PointId = "2.10", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            // Station 3 (points 1..10)
            new ChargingPort { Id = "3.1.1", PointId = "3.1", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.1.2", PointId = "3.1", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.1.3", PointId = "3.1", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "3.2.1", PointId = "3.2", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.2.2", PointId = "3.2", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.2.3", PointId = "3.2", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "3.3.1", PointId = "3.3", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.3.2", PointId = "3.3", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.3.3", PointId = "3.3", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "3.4.1", PointId = "3.4", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.4.2", PointId = "3.4", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.4.3", PointId = "3.4", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "3.5.1", PointId = "3.5", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.5.2", PointId = "3.5", ConnectorId = 2, Power = 150, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.5.3", PointId = "3.5", ConnectorId = 3, Power = 150, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "3.6.1", PointId = "3.6", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.6.2", PointId = "3.6", ConnectorId = 2, Power = 150, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.6.3", PointId = "3.6", ConnectorId = 3, Power = 150, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "3.7.1", PointId = "3.7", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.7.2", PointId = "3.7", ConnectorId = 2, Power = 350, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.7.3", PointId = "3.7", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "3.8.1", PointId = "3.8", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.8.2", PointId = "3.8", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.8.3", PointId = "3.8", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "3.9.1", PointId = "3.9", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.9.2", PointId = "3.9", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.9.3", PointId = "3.9", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "3.10.1", PointId = "3.10", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.10.2", PointId = "3.10", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "3.10.3", PointId = "3.10", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            // Station 4 (points 1..10)
            new ChargingPort { Id = "4.1.1", PointId = "4.1", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.1.2", PointId = "4.1", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.1.3", PointId = "4.1", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "4.2.1", PointId = "4.2", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.2.2", PointId = "4.2", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.2.3", PointId = "4.2", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "4.3.1", PointId = "4.3", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.3.2", PointId = "4.3", ConnectorId = 2, Power = 150, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.3.3", PointId = "4.3", ConnectorId = 3, Power = 150, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "4.4.1", PointId = "4.4", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.4.2", PointId = "4.4", ConnectorId = 2, Power = 150, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.4.3", PointId = "4.4", ConnectorId = 3, Power = 450, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "4.5.1", PointId = "4.5", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.5.2", PointId = "4.5", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.5.3", PointId = "4.5", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "4.6.1", PointId = "4.6", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.6.2", PointId = "4.6", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.6.3", PointId = "4.6", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "4.7.1", PointId = "4.7", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.7.2", PointId = "4.7", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.7.3", PointId = "4.7", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "4.8.1", PointId = "4.8", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.8.2", PointId = "4.8", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.8.3", PointId = "4.8", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "4.9.1", PointId = "4.9", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.9.2", PointId = "4.9", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.9.3", PointId = "4.9", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "4.10.1", PointId = "4.10", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.10.2", PointId = "4.10", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "4.10.3", PointId = "4.10", ConnectorId = 3, Power = 150, Status = ChargingPortStatus.Available },

            // Station 5 (points 1..10)
            new ChargingPort { Id = "5.1.1", PointId = "5.1", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.1.2", PointId = "5.1", ConnectorId = 2, Power = 150, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.1.3", PointId = "5.1", ConnectorId = 3, Power = 150, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "5.2.1", PointId = "5.2", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.2.2", PointId = "5.2", ConnectorId = 2, Power = 350, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.2.3", PointId = "5.2", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "5.3.1", PointId = "5.3", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.3.2", PointId = "5.3", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.3.3", PointId = "5.3", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "5.4.1", PointId = "5.4", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.4.2", PointId = "5.4", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.4.3", PointId = "5.4", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "5.5.1", PointId = "5.5", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.5.2", PointId = "5.5", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.5.3", PointId = "5.5", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "5.6.1", PointId = "5.6", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.6.2", PointId = "5.6", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.6.3", PointId = "5.6", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "5.7.1", PointId = "5.7", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.7.2", PointId = "5.7", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.7.3", PointId = "5.7", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "5.8.1", PointId = "5.8", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.8.2", PointId = "5.8", ConnectorId = 2, Power = 150, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.8.3", PointId = "5.8", ConnectorId = 3, Power = 150, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "5.9.1", PointId = "5.9", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.9.2", PointId = "5.9", ConnectorId = 2, Power = 150, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.9.3", PointId = "5.9", ConnectorId = 3, Power = 150, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "5.10.1", PointId = "5.10", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.10.2", PointId = "5.10", ConnectorId = 2, Power = 350, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "5.10.3", PointId = "5.10", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            // Station 6 (points 1..10)
            new ChargingPort { Id = "6.1.1", PointId = "6.1", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.1.2", PointId = "6.1", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.1.3", PointId = "6.1", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "6.2.1", PointId = "6.2", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.2.2", PointId = "6.2", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.2.3", PointId = "6.2", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "6.3.1", PointId = "6.3", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.3.2", PointId = "6.3", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.3.3", PointId = "6.3", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "6.4.1", PointId = "6.4", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.4.2", PointId = "6.4", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.4.3", PointId = "6.4", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "6.5.1", PointId = "6.5", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.5.2", PointId = "6.5", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.5.3", PointId = "6.5", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "6.6.1", PointId = "6.6", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.6.2", PointId = "6.6", ConnectorId = 2, Power = 150, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.6.3", PointId = "6.6", ConnectorId = 3, Power = 150, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "6.7.1", PointId = "6.7", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.7.2", PointId = "6.7", ConnectorId = 2, Power = 150, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.7.3", PointId = "6.7", ConnectorId = 3, Power = 150, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "6.8.1", PointId = "6.8", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.8.2", PointId = "6.8", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.8.3", PointId = "6.8", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "6.9.1", PointId = "6.9", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.9.2", PointId = "6.9", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.9.3", PointId = "6.9", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "6.10.1", PointId = "6.10", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.10.2", PointId = "6.10", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "6.10.3", PointId = "6.10", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            // Station 7 (points 1..10)
            new ChargingPort { Id = "7.1.1", PointId = "7.1", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.1.2", PointId = "7.1", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.1.3", PointId = "7.1", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "7.2.1", PointId = "7.2", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.2.2", PointId = "7.2", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.2.3", PointId = "7.2", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "7.3.1", PointId = "7.3", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.3.2", PointId = "7.3", ConnectorId = 2, Power = 150, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.3.3", PointId = "7.3", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "7.4.1", PointId = "7.4", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.4.2", PointId = "7.4", ConnectorId = 2, Power = 150, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.4.3", PointId = "7.4", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "7.5.1", PointId = "7.5", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.5.2", PointId = "7.5", ConnectorId = 2, Power = 350, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.5.3", PointId = "7.5", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "7.6.1", PointId = "7.6", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.6.2", PointId = "7.6", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.6.3", PointId = "7.6", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "7.7.1", PointId = "7.7", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.7.2", PointId = "7.7", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.7.3", PointId = "7.7", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "7.8.1", PointId = "7.8", ConnectorId = 1, Power = 11, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.8.2", PointId = "7.8", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.8.3", PointId = "7.8", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "7.9.1", PointId = "7.9", ConnectorId = 1, Power = 22, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.9.2", PointId = "7.9", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.9.3", PointId = "7.9", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available },

            new ChargingPort { Id = "7.10.1", PointId = "7.10", ConnectorId = 1, Power = 7, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.10.2", PointId = "7.10", ConnectorId = 2, Power = 50, Status = ChargingPortStatus.Available },
            new ChargingPort { Id = "7.10.3", PointId = "7.10", ConnectorId = 3, Power = 50, Status = ChargingPortStatus.Available }
        );
    ...
    new PaymentTransaction
    {
        ...
        ResponseCode = "05", TransactionStatus = "05", OrderInfo = "Payment for Nissan Leaf (Aug-2025) - FAILED"
    },
    new PaymentTransaction
    {
    ...
    new PaymentTransaction
    {
        ...
        ResponseCode = "11", TransactionStatus = "11", OrderInfo = "Payment for BYD Seal (Sep-2025) - FAILED"
    },
    new PaymentTransaction
    {
    ...
    new PaymentTransaction
    {
        ...
        ResponseCode = "24", TransactionStatus = "24", OrderInfo = "Payment for Volvo EX30 (Sep-2025) - FAILED"
    },
    new PaymentTransaction
    {
    ...
    new PaymentTransaction
    {
        ...
        ResponseCode = "09", TransactionStatus = "09", OrderInfo = "Payment for Kia EV6 (Oct-2025) - FAILED"
    },
    new PaymentTransaction
    {
    ...
    new PaymentTransaction
    {
        ...
        ResponseCode = "24", TransactionStatus = "24", OrderInfo = "Payment for VinFast VF 8 (Nov-2025) - FAILED"
    },
    new PaymentTransaction
    {
