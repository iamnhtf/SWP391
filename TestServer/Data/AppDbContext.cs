...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder
            ...
            .HasData(
                new ChargingStation
                {
                    ...
                    Location =
                        "778 Nguyen Van Qua, Dong Hung Thuan Ward, District 12, Ho Chi Minh City",
                ...
                new ChargingStation
                {
                    ...
                    Location =
                        "Basement B3, Léman Luxury Apartments, 117 Nguyễn Đình Chiểu, Ward 6, District 3, Ho Chi Minh City",
                ...
                new ChargingStation
                {
                    ...
                    Location =
                        "Basement B2, 15 Nguyen Luong Bang, Tan Phu Ward, District 7, Ho Chi Minh City",
                ...
                new ChargingStation
                {
                    ...
                    Location =
                        "71 Tran Trong Cung, Tan Thuan Dong Ward, District 7, Ho Chi Minh City",
        ...
        modelBuilder.Entity<Vehicle>().Property(v => v.Status).HasConversion<string>();
        ...
        modelBuilder.Entity<ChargingPort>().Property(c => c.Status).HasConversion<string>();

        modelBuilder
            .Entity<ChargingPoint>()
        ...
        modelBuilder
            ...
            .HasData(
                ...
                new ChargingPort
                {
                    ...
                    ConnectorId = 1,
                    Power = 7,
                    Status = ChargingPortStatus.Available,
                },
                new ChargingPort
                {
                    Id = "1.1.2",
                    ...
                    ConnectorId = 2,
                    Power = 22,
                    Status = ChargingPortStatus.InUse,
                },
                new ChargingPort
                {
                    Id = "1.1.3",
                ...
                new ChargingPort
                {
                    ...
                    ConnectorId = 2,
                    Power = 22,
                    Status = ChargingPortStatus.Faulty,
                },
                new ChargingPort
                {
                    Id = "1.2.3",
        ...
        modelBuilder
            .Entity<VehicleConnectorType>()
            .HasKey(vtc => new { vtc.VehicleId, vtc.ConnectorId });
        ...
        modelBuilder
            ...
            .HasData(
                new PriceTable
                {
                    ...
                    ValidFrom = new DateTime(2024, 3, 19),
