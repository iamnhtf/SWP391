    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 619623.0, new DateTime(2025, 8, 2, 9, 10, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 1 (Jul-2025)", "00", "00", 1, 1 },
                    { 2, 498068.0, new DateTime(2025, 8, 2, 9, 11, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 2 (Jul-2025)", "00", "00", 2, 2 },
                    { 3, 231866.0, new DateTime(2025, 8, 2, 9, 12, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 3 (Jul-2025)", "00", "00", 3, 3 },
                    { 4, 637921.0, new DateTime(2025, 8, 2, 9, 13, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 4 (Jul-2025)", "00", "00", 4, 4 },
                    { 5, 519563.0, new DateTime(2025, 8, 2, 9, 14, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 5 (Jul-2025)", "00", "00", 5, 5 },
                    { 6, 454045.0, new DateTime(2025, 8, 3, 10, 5, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for VMonth 6 (Jul-2025)", "00", "00", 6, 6 },
                    { 7, 248033.0, new DateTime(2025, 8, 3, 10, 6, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for VMonth 7 (Jul-2025)", "00", "00", 7, 7 },
                    { 8, 285918.0, new DateTime(2025, 8, 3, 10, 7, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for VMonth 8 (Jul-2025)", "00", "00", 8, 8 },
                    { 9, 506409.0, new DateTime(2025, 8, 3, 10, 8, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for VMonth 9 (Jul-2025)", "00", "00", 9, 9 },
                    { 10, 441017.0, new DateTime(2025, 8, 1, 11, 20, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for VMonth 10 (Jul-2025)", "00", "00", 10, 10 },
                    { 11, 267710.0, new DateTime(2025, 8, 1, 11, 21, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for VMonth 11 (Jul-2025)", "00", "00", 11, 11 },
                    { 12, 678314.0, new DateTime(2025, 8, 1, 11, 22, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for VMonth 12 (Jul-2025)", "00", "00", 12, 12 },
                    { 13, 321150.0, new DateTime(2025, 8, 1, 11, 23, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for VMonth 13 (Jul-2025)", "00", "00", 13, 13 },
                    { 14, 441017.0, new DateTime(2025, 9, 2, 8, 30, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 14 (Aug-2025)", "00", "00", 1, 14 },
                    { 15, 498839.0, new DateTime(2025, 9, 2, 8, 31, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 15 (Aug-2025)", "00", "00", 2, 15 },
                    { 16, 500383.0, new DateTime(2025, 9, 2, 8, 32, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 16 (Aug-2025) - FAILED (Insufficient)", "05", "05", 3, 16 },
                    { 17, 321536.0, new DateTime(2025, 9, 2, 8, 33, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 17 (Aug-2025)", "00", "00", 4, 17 },
                    { 18, 701468.0, new DateTime(2025, 9, 2, 8, 34, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 18 (Aug-2025)", "00", "00", 5, 18 },
                    { 19, 538787.0, new DateTime(2025, 9, 3, 11, 15, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for VMonth 19 (Aug-2025)", "00", "00", 6, 19 },
                    { 20, 504626.0, new DateTime(2025, 9, 3, 11, 16, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for VMonth 20 (Aug-2025)", "00", "00", 7, 20 },
                    { 21, 527581.0, new DateTime(2025, 9, 3, 11, 17, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for VMonth 21 (Aug-2025)", "00", "00", 8, 21 },
                    { 22, 310931.0, new DateTime(2025, 9, 3, 11, 18, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for VMonth 22 (Aug-2025)", "00", "00", 9, 22 },
                    { 23, 293644.0, new DateTime(2025, 9, 1, 14, 0, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for VMonth 23 (Aug-2025)", "00", "00", 10, 23 },
                    { 24, 421449.0, new DateTime(2025, 9, 1, 14, 1, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for VMonth 24 (Aug-2025)", "00", "00", 11, 24 },
                    { 25, 333657.0, new DateTime(2025, 9, 1, 14, 2, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for VMonth 25 (Aug-2025)", "00", "00", 12, 25 },
                    { 26, 662990.0, new DateTime(2025, 9, 1, 14, 3, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for VMonth 26 (Aug-2025)", "00", "00", 13, 26 },
                    { 27, 299085.0, new DateTime(2025, 10, 2, 9, 0, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 27 (Sep-2025)", "00", "00", 1, 27 },
                    { 28, 669483.0, new DateTime(2025, 10, 2, 9, 1, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 28 (Sep-2025)", "00", "00", 2, 28 },
                    { 29, 319128.0, new DateTime(2025, 10, 2, 9, 2, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 30 (Sep-2025)", "00", "00", 4, 30 },
                    { 30, 517272.0, new DateTime(2025, 10, 2, 9, 3, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 31 (Sep-2025)", "00", "00", 5, 31 },
                    { 31, 451730.0, new DateTime(2025, 10, 3, 10, 10, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for VMonth 32 (Sep-2025)", "00", "00", 6, 32 },
                    { 32, 530860.0, new DateTime(2025, 10, 3, 10, 11, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for VMonth 33 (Sep-2025)", "00", "00", 7, 33 },
                    { 33, 527581.0, new DateTime(2025, 10, 3, 10, 12, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for VMonth 34 (Sep-2025) - FAILED (Timeout)", "11", "11", 8, 34 },
                    { 34, 361097.0, new DateTime(2025, 10, 3, 10, 13, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for VMonth 35 (Sep-2025)", "00", "00", 9, 35 },
                    { 35, 289876.0, new DateTime(2025, 10, 1, 12, 0, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for VMonth 36 (Sep-2025)", "00", "00", 10, 36 },
                    { 36, 269228.0, new DateTime(2025, 10, 1, 12, 1, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for VMonth 37 (Sep-2025) - FAILED (Cancelled)", "24", "24", 11, 37 },
                    { 37, 675276.0, new DateTime(2025, 10, 1, 12, 2, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for VMonth 38 (Sep-2025)", "00", "00", 12, 38 },
                    { 38, 319514.0, new DateTime(2025, 10, 1, 12, 3, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for VMonth 39 (Sep-2025)", "00", "00", 13, 39 },
                    { 39, 449275.0, new DateTime(2025, 11, 2, 10, 0, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 40 (Oct-2025)", "00", "00", 1, 40 },
                    { 40, 347220.0, new DateTime(2025, 11, 2, 10, 1, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 41 (Oct-2025)", "00", "00", 2, 41 },
                    { 41, 632832.0, new DateTime(2025, 11, 2, 10, 2, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 43 (Oct-2025)", "00", "00", 4, 43 },
                    { 42, 519563.0, new DateTime(2025, 11, 2, 10, 3, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 44 (Oct-2025) - FAILED (Card inactive)", "09", "09", 5, 44 },
                    { 43, 288975.0, new DateTime(2025, 11, 3, 11, 0, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for VMonth 45 (Oct-2025)", "00", "00", 6, 45 },
                    { 44, 381398.0, new DateTime(2025, 11, 3, 11, 1, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for VMonth 46 (Oct-2025)", "00", "00", 7, 46 },
                    { 45, 361097.0, new DateTime(2025, 11, 3, 11, 2, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for VMonth 48 (Oct-2025)", "00", "00", 9, 48 },
                    { 46, 288397.0, new DateTime(2025, 11, 1, 15, 0, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for VMonth 49 (Oct-2025)", "00", "00", 10, 49 },
                    { 47, 328336.0, new DateTime(2025, 11, 1, 15, 1, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for VMonth 51 (Oct-2025)", "00", "00", 12, 51 },
                    { 48, 482708.0, new DateTime(2025, 11, 1, 15, 2, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for VMonth 52 (Oct-2025)", "00", "00", 13, 52 },
                    { 49, 157070.0, new DateTime(2025, 11, 10, 9, 0, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 53 (Nov-2025)", "00", "00", 1, 53 },
                    { 50, 180237.0, new DateTime(2025, 11, 10, 9, 5, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 54 (Nov-2025) - FAILED (Cancelled)", "24", "24", 2, 54 },
                    { 51, 317971.0, new DateTime(2025, 11, 11, 14, 20, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VMonth 56 (Nov-2025)", "00", "00", 4, 56 },
                    { 52, 138888.0, new DateTime(2025, 11, 11, 16, 0, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for VMonth 58 (Nov-2025)", "00", "00", 6, 58 },
                    { 53, 109247.0, new DateTime(2025, 11, 12, 8, 0, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for VMonth 61 (Nov-2025)", "00", "00", 9, 61 },
                    { 54, 158178.0, new DateTime(2025, 11, 12, 9, 30, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for VMonth 64 (Nov-2025)", "00", "00", 12, 64 }
                });
