    ...
    public partial class InitCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 619623.0, new DateTime(2025, 8, 2, 9, 10, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for Tesla Model 3 (Jul-2025)", "00", "00", 1, 1 },
                    { 2, 498068.0, new DateTime(2025, 8, 2, 9, 11, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VinFast VF 8 (Jul-2025)", "00", "00", 2, 2 },
                    { 3, 231866.0, new DateTime(2025, 8, 2, 9, 12, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for Nissan Leaf (Jul-2025)", "00", "00", 3, 3 },
                    { 4, 637921.0, new DateTime(2025, 8, 2, 9, 13, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for Hyundai Ioniq 5 (Jul-2025)", "00", "00", 4, 4 },
                    { 5, 519563.0, new DateTime(2025, 8, 2, 9, 14, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for Kia EV6 (Jul-2025)", "00", "00", 5, 5 },
                    { 6, 454045.0, new DateTime(2025, 8, 3, 10, 5, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for Tesla Model Y (Jul-2025)", "00", "00", 6, 6 },
                    { 7, 248033.0, new DateTime(2025, 8, 3, 10, 6, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for Tesla Model 4 (Jul-2025)", "00", "00", 7, 7 },
                    { 8, 285918.0, new DateTime(2025, 8, 3, 10, 7, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for BYD Seal (Jul-2025)", "00", "00", 8, 8 },
                    { 9, 506409.0, new DateTime(2025, 8, 3, 10, 8, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for Ford F-150 Lightning (Jul-2025)", "00", "00", 9, 9 },
                    { 10, 441017.0, new DateTime(2025, 8, 1, 11, 20, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for Chevrolet Bolt EV (Jul-2025)", "00", "00", 10, 10 },
                    { 11, 267710.0, new DateTime(2025, 8, 1, 11, 21, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for Volvo EX30 (Jul-2025)", "00", "00", 11, 11 },
                    { 12, 678314.0, new DateTime(2025, 8, 1, 11, 22, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for Audi e-tron GT (Jul-2025)", "00", "00", 12, 12 },
                    ...
                    { 20, 504626.0, new DateTime(2025, 9, 3, 11, 16, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for Tesla Model 4 (Aug-2025)", "00", "00", 7, 20 },
                    { 21, 527581.0, new DateTime(2025, 9, 3, 11, 17, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for BYD Seal (Aug-2025)", "00", "00", 8, 21 },
                    { 22, 310931.0, new DateTime(2025, 9, 3, 11, 18, 0, 0, DateTimeKind.Utc), "l1sufzGdTdYyIZJ8c0VypXyhmR02", "Payment for Ford F-150 Lightning (Aug-2025)", "00", "00", 9, 22 },
                    { 23, 293644.0, new DateTime(2025, 9, 1, 14, 0, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for Chevrolet Bolt EV (Aug-2025)", "00", "00", 10, 23 },
                    { 24, 421449.0, new DateTime(2025, 9, 1, 14, 1, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for Volvo EX30 (Aug-2025)", "00", "00", 11, 24 },
                    { 25, 333657.0, new DateTime(2025, 9, 1, 14, 2, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for Audi e-tron GT (Aug-2025)", "00", "00", 12, 25 },
                    { 26, 662990.0, new DateTime(2025, 9, 1, 14, 3, 0, 0, DateTimeKind.Utc), "JEBFEGirUGhlgQadF4xRrofZo9X2", "Payment for Porsche Taycan (Aug-2025)", "00", "00", 13, 26 },
                    { 27, 299085.0, new DateTime(2025, 10, 2, 9, 0, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for Tesla Model 3 (Sep-2025)", "00", "00", 1, 27 },
                    { 28, 669483.0, new DateTime(2025, 10, 2, 9, 1, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for VinFast VF 8 (Sep-2025)", "00", "00", 2, 28 },
                    { 29, 319128.0, new DateTime(2025, 10, 2, 9, 2, 0, 0, DateTimeKind.Utc), "k825tKKC1aex70inOKxd2lQpJUD3", "Payment for Hyundai Ioniq 5 (Sep-2025)", "00", "00", 4, 30 },
